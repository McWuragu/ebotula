...
#define MESSAGE_GER_H
	...
	#define SYSLOG_TRY_CONNECT		"Versuche an %s zuverbinden:%s"
	...
	#define SYSLOG_FAILED_NETPARA	"DerServername oder die Protnummer wurden nicht gesetzt"
	...
	#define ERR_PORT_PARAMETER		"Protnummer liegt aussrhalb  des Bereiches"
	#define ERR_WRONG_SERVERNAME	"Servername ist unzulässig"
	#define ERR_WRONG_BOTNAME		"Botname is  unzulassig"
	#define ERR_ALT_RANGE			"Die  Accountlebenserwartung is ungültig"
	#define ERR_PINGTIMEOUT_RANGE	"Die Pingtimeoutzeit is ungültig"
	...
	#define MSG_HELLO				"Schön dich zutreffen"
	...
	#define MSG_RESTART_OK			"Der Bot macht einen Neustart"
	...
	#define MSG_NOT_OWNER			"Du bsit nicht der Channeleigentümer"
	...
	#define MSG_NOT_SELF			"Du kansnt  dich nicht selbst modifizieren"
	...
	#define MSG_ADDCHANNEL_ERR		"Ungültig Kommando: !addchannel <#channel>"
	#define MSG_JOIN_ERR			"Ungültig Kommando: !join <#channel>"
	#define MSG_IDENT_ERR			"Ungültig Kommando: !ident <login password>"
	#define MSG_NICK_ERR			"Ungültig Kommando: !nick <nickname>"			
	#define MSG_SAY_ERR			    "Ungültig Kommando: !say [#channel] <message>"			
	#define MSG_KICK_ERR			"Ungültig Kommando: !kick [#channel] <nickname> [reason]"
	#define MSG_USERMODE_ERR		"Ungültig Kommando: !usermode [#channel] <login> <+/-><mod>"
	#define MSG_CHANMODE_ERR		"Ungültig Kommando: !chamode [#channel] <+/-><mods>"
	...
	#define MSG_MASTER_REPASS		"Passwort nochmal: "
	...
	static char *const help_msg[]=
	{
		...
		"\t-t Anzahl\tSetzt die Anzaahl der zuerzeugenden Threads.\n"
